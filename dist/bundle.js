...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pixelation = __webpack_require__(193);
	    ...
	    _createClass(Pixelation, [{
	        ...
	        value: function run() {
	            ...
	            this.preload().then(function () {
	                return _this.bgLoad().then(function () {
	                    return _this.setup();
	                });
	            });
	        }
	        ...
	        value: function setup() {
	            ...
	            var screen_width = this.wW;
	            var screen_height = this.wH;
	            ...
	            /* define font style */
	            // text
	            var text = decodeURI(getQueryVariable('text'));
	            if (text == 'undefined') {
	                text = 'Mawaru';
	            }
	
	            var textWidth = this.wW * 95 / 100;
	            var textHeight = textWidth / text.length;
	
	            var fontSize = String(Math.floor(textHeight)) + 'px';
	            var fontKind = 'Futura, YuGothic';
	            imagecontext.textAlign = "center";
	            imagecontext.font = fontSize + ' ' + fontKind;
	            imagecontext.fillStyle = "white";
	
	            var textPosX = this.wW / 2;
	            var textPosY = this.wH / 2 + textHeight / 4;
	            ...
	            var geometory = new THREE.PlaneGeometry(this.wW, this.wH, 1);
	            // let material = new THREE.MeshBasicMaterial( {map: imagetexture} )
	
	            var plane = new THREE.Mesh(geometory, material);
	            this.scene.add(plane);
	
	            var duration = 7000;
	            new TWEEN.Tween(this.uniforms.vx_offset).to({ value: 1.1 }, duration).easing(TWEEN.Easing.Quartic.InOut).start();
