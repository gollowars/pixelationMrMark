...
export default class Pixelation {
  ...
  bgLoad(){
    ...
    this.bgImage.src = "./images/mark.jpg";
  ...
  setup(){
    ...
    this.time = 1.0
    this.uniforms = {
        sceneTex: { type: 't', value: imagetexture },
        vx_offset:{type: "f", value: 0.0},
        rt_w:{type: "f", value: imagecanvas.width},
        rt_h:{type: "f", value: imagecanvas.height},
        pixel_w:{type: "f", value: 70.0},
        pixel_h:{type: "f", value: 60.0},
    ...
    let duration = 7000
    new TWEEN.Tween(this.uniforms.vx_offset)
    .to({value:1.1},duration)
